...
class analysisWindow(Screen):
    ...
    return gammaCorrection(src, gamma)
    ...
    def clips(width, height, start, end):
        ...
        return first, second
    return clips(width, height, start, end)
    ...
    return reagentDetection(first, second, height)
    ...
    def bigBottleDetection(height, start, end, first, second):
        ...
        return fluidVolume
    return bigBottleDetection(height, start, end, first, second)
    ...
    def smallBottleDetection(height, start, end, first, second):
        ...
        return fluidVolume
    return smallBottleDetection(height, start, end, first, second)
