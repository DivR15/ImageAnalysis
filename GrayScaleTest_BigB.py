...
'''The next for loop starts from 45 pixels above the bottle bottom to eliminate the shadow produces near the bottom and takes the average of 10 rows of pixels.'''
